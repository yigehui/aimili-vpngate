...
class VpnGateBatchProbeTests(unittest.TestCase):
    ...
    def test_test_multiple_nodes_syncs_available_results_to_pool_once_after_batch(self) -> None:
        ...
        pool_manager.replace_pool_from_nodes.assert_called_once()
        replaced_nodes = pool_manager.replace_pool_from_nodes.call_args.args[0]
        self.assertEqual([node["id"] for node in replaced_nodes], ["node-1"])
        self.assertEqual(pool_manager.replace_pool_from_nodes.call_args.kwargs, {})
    ...
    def test_maintain_valid_nodes_does_not_sync_pool_outside_batch_probe(self) -> None:
        ...
        pool_manager.replace_pool_from_nodes.assert_not_called()
